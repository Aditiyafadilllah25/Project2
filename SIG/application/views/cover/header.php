                                    ...
                                    <div class="dropdown-menu extended animated fadeIn" aria-labelledby="navbarDropdown">
                                        <ul>
                                            <li class="dropdown-header bg-gradient p-4 text-white text-left">Messages
                                                ...
                                                <a href="index.html#" class="float-right btn btn-square btn-inverse-light btn-xs m-0">
                                    ...
                                    <div class="dropdown-menu animated fadeIn" aria-labelledby="navbarDropdown">
                                        <div class="bg-gradient px-4 py-3">
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <a href="index.html#" class="text-white font-20 tooltip-wrapper" data-toggle="tooltip" data-placement="top" title="" data-original-title="Logout"> <i
                                        ...
                                        <div class="p-4">
                                            ...
                                            <div class="row mt-2">
                                                <div class="col">
                                                    <a class="bg-light p-3 text-center d-block" href="index.html#">
                    ...
                    <div class="sidebar-nav scrollbar scroll_light">
                        <ul class="metismenu " id="sidebarNav">
                            ...
                            <li class="sidebar-banner p-4 bg-gradient text-center m-3 d-block rounded">
                                ...
                                <a class="btn btn-square btn-inverse-light btn-xs d-inline-block mt-2 mb-0" href="index.html#"> Buy now</a>
                            </li>
                        </ul>
                    </div>
                    <!-- end sidebar-nav -->
