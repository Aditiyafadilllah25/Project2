                                        ...
                                        <div class="col-xxl-3 col-lg-6">
                                            <div class="p-20 border-lg-right border-bottom border-xxl-bottom-0">
                                                <div class="d-flex m-b-10">
                                                    ...
                                                    <a class="mb-0 ml-auto font-weight-bold" href="index.html#"><i class="ti ti-more-alt"></i> </a>
                                                </div>
                            ...
                            <div class="col-xxl-5 m-b-30">
                                <div class="card card-statistics h-100 mb-0">
                                    <div class="card-header d-flex justify-content-between">
                                        ...
                                        <div class="dropdown">
                                            <a class="p-2" href="index.html#!" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <i class="fe fe-circle"></i>
                                            </a>
                                            <div class="dropdown-menu custom-dropdown dropdown-menu-right p-4">
                                                <h6 class="mb-1">Action</h6>
                                                <a class="dropdown-item" href="index.html#!"><i class="fa-fw fa fa-file-o pr-2"></i>View reports</a>
                                                <a class="dropdown-item" href="index.html#!"><i class="fa-fw fa fa-edit pr-2"></i>Edit reports</a>
                                                <a class="dropdown-item" href="index.html#!"><i class="fa-fw fa fa-bar-chart-o pr-2"></i>Statistics</a>
                                                <h6 class="mb-1 mt-3">Export</h6>
                                                <a class="dropdown-item" href="index.html#!"><i class="fa-fw fa fa-file-pdf-o pr-2"></i>Export to PDF</a>
                                                <a class="dropdown-item" href="index.html#!"><i class="fa-fw fa fa-file-excel-o pr-2"></i>Export to CSV</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-xs-6">
                                                ...
                                                <a class="btn btn-round btn-inverse-primary mb-3 mb-sm-0" href="index.html#"><b>View details </b></a>
                                            </div>
                                            <div class="col-xs-6">
                                                <div class="apexchart-wrapper">
                            ...
                            <div class="col-lg-6 col-xxl-4 m-b-30">
                                <div class="card card-statistics h-100 mb-0">
                                    <div class="card-header d-flex justify-content-between">
                                        ...
                                        <div class="dropdown">
                                            <a class="btn btn-round btn-inverse-primary btn-xs" href="index.html#">View all </a>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="row active-task m-b-20">
                                            ...
                                            <div class="col-11">
                                                ...
                                                <h5 class="mb-0"><a href="index.html#">Unread utf-8 in more quick overview</a></h5>
                                        ...
                                        <div class="row active-task m-b-20">
                                            ...
                                            <div class="col-11">
                                                ...
                                                <h5 class="mb-0"><a href="index.html#">I get an error "No Direct Access Allowed!" when I enter purchase</a></h5>
                                                <ul class="list-unstyled list-inline">
                                                    <li class="list-inline-item">
                                        ...
                                        <div class="row active-task m-b-20">
                                            ...
                                            <div class="col-11">
                                                ...
                                                <h5 class="mb-0"><a href="index.html#">OAuth Credentials not generating the key</a></h5>
                                                <ul class="list-unstyled list-inline">
                                                    <li class="list-inline-item">
                                        ...
                                        <div class="row active-task m-b-20">
                                            ...
                                            <div class="col-11">
                                                ...
                                                <h5 class="mb-0"><a href="index.html#">Pre-Buy Questions : For bakery Shop (Mentor Android Application)</a></h5>
                                                <ul class="list-unstyled list-inline">
                                                    <li class="list-inline-item">
                                        ...
                                        <div class="row active-task m-b-20">
                                            ...
                                            <div class="col-11">
                                                ...
                                                <h5 class="mb-0"><a href="index.html#">I need a payment option, for each seller per item</a></h5>
                                                <ul class="list-unstyled list-inline">
                                                    <li class="list-inline-item">
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-xl-4">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <a class="btn btn-link pl-0" href="index.html#"><b>View details </b></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-8">
                                    ...
                                    <div class="mt-3">
                                        <div class="tab nav-border-bottom">
                                            <ul class="nav nav-tabs" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link py-2 active show" id="home-02-tab" data-toggle="tab" href="index.html#home-02" role="tab" aria-controls="home-02" aria-selected="true">Views</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link py-2" id="profile-02-tab" data-toggle="tab" href="index.html#profile-02" role="tab" aria-controls="profile-02" aria-selected="false">Likes </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link py-2" id="portfolio-02-tab" data-toggle="tab" href="index.html#portfolio-02" role="tab" aria-controls="portfolio-02" aria-selected="false">Comments </a>
                                                </li>
                                            </ul>
